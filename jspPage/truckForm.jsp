...
<html>
	...
	<body>
		...
		<div id="jb-container">
            ...
            <h2></h2>
                <div id="loginbox">
                	<form action="addTruck" name="select" method="post">
						<table>
							<tr>
								<td>등록아이디</td>
								<td><input type="text" name="user_id" value=${sessionScope.loginId} readonly></td>
							</tr>
							<tr>	
								<td>상호명</td>
							...
							<tr>
								<td>영업시간</td>
								<td><input type="text" name="comp_time"/></td>
							</tr>
							<tr>
								<td>대표전화</td>
								<td><input type="text" name="comp_phone"/></td>
							</tr>
							<tr>
								<td>메뉴판 내용</td>
								<td>
							...
							<tr>
								<td>카드여부</td>
								<td>
									가능<input type="radio" name="card" value="on"/>
									불가능<input type="radio" name="card" value="off"/>
								</td>
							</tr>
							<tr>
								<td colspan="2">
